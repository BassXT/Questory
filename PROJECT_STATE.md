...
- Die visuelle Avatar-Darstellung nutzt den Questory-eigenen `SoftAdventureAvatarGraphic`-Renderer. Alle sichtbaren Teile werden in einem gemeinsamen `360x520`-SVG-Koordinatensystem gezeichnet. Der verbindliche Stil ist eine weich schattierte Abenteuerillustration mit klarer Line-Art, kindlichen Ganzkoerperproportionen und modularen Cel-Shading-Layern; externe Avatar-APIs und DiceBear-Pakete sind nicht mehr notwendig.
