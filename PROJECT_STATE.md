...
- Die visuelle Avatar-Darstellung nutzt `@dicebear/core` und `@dicebear/toon-head` ueber lokale npm-Pakete. Das vermeidet externe API-Abhaengigkeit, nutzt professionelle Avatar-Assets statt selbst gezeichneter SVG-Pfade und buendelt nicht die komplette DiceBear-Collection. Toon Head ist ebenfalls ein Kopf-/Oberkoerper-Stil; echte Ganzkoerper-Avatare bleiben ein separater spaeterer Renderer-/Asset-Slice.
