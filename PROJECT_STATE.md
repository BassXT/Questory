...
- Kuratierten CC0-Referenzsatz aus `Kenney Modular Characters` mitsamt Originallizenz und Quellenhinweis unter `apps/frontend/public/avatar-kenney/v1` importiert.
...
Den kleinen Kenney-Referenzsatz auf dem echten iPhone und mit vorhandenen Familien-Loadouts pruefen. Nach Stilfreigabe wird der Kenney-Katalog schrittweise um weitere kompatible Haare, Oberteile, Unterteile und Schuhe erweitert; besondere Huete, Tiere und Fantasy-Gegenstaende bleiben ein eigener spaeterer Art-Slice.
...
- Die visuelle Avatar-Darstellung nutzt `KenneyAvatarGraphic`. Das gemeinsame `360x520`-SVG-Koordinatensystem normalisiert kompatible Kenney-PNG-Einzelteile auf ein festes kindliches Rig und faerbt dafuer geeignete Teile ueber lokale SVG-Masken. Eine feste Zeichenreihenfolge kontrolliert Ueberdeckungen; ergaenzende Questory-Accessoires verwenden weiterhin benannte Anker. Es gibt keine externe Avatar-API und keinen zweiten Ganzkoerper unter der sichtbaren Kleidung.
...
- Der importierte Kenney-Referenzsatz bildet bewusst noch nicht alle bestehenden Katalog-Keys als eigene Grafik ab: Mehrere Keys teilen sich aktuell dieselbe Grundform und unterscheiden sich durch Farbe oder aufgesetztes Muster. Die vorhandenen Questory-Picker-Thumbnails koennen deshalb vom grossen Kenney-Avatar abweichen.
- Der kostenlose Kenney-Katalog deckt Haut, Gesicht, Haare, Oberteile, Hosen und Schuhe ab, aber keine umfangreichen Questory-spezifischen Huete, Tiere, Taschen oder Fantasy-Gadgets. Diese Extras verwenden vorerst die bestehenden illustrierten Anker-Assets und muessen spaeter als eigene kompatible CC0-/Questory-Layer vereinheitlicht werden.
