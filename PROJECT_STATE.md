...
- Die visuelle Avatar-Darstellung nutzt den Questory-eigenen `SoftAdventureAvatarGraphic`-Renderer. Alle sichtbaren Teile werden in einem gemeinsamen `360x520`-SVG-Koordinatensystem gezeichnet; externe Avatar-APIs und DiceBear-Pakete sind nicht mehr notwendig.
