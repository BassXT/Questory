...
- Die freigegebene Zielrichtung ist ein statischer 2D-Paper-Doll-Builder mit echten transparenten Ganzkoerper-Layern auf identischer Leinwand und Pose. Der verbindliche Import- und Ebenenvertrag steht in `docs/design/AVATAR_ASSET_CONTRACT.md`. Geschlechter duerfen getrennte kompatible Layerkataloge besitzen; Grundfarben bleiben frei, waehrend besondere Stile ueber Level freigeschaltet werden.
