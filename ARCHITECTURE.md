...
- Avatarquellen muessen kostenlos und mit dem oeffentlichen Repository kompatibel sein; CC0 wird bevorzugt. `Kenney Modular Characters` ist mit 425 PNG-Elementen die aktuell vorgesehene Rig-Basis. Fuer die endgueltige Darstellung bleiben eine verbindliche Masterpose, definierte Gelenk-/Koerperanker und feste Zeichenebenen notwendig. Die Zielarchitektur folgt damit weiterhin bewaehrten Mustern aus [Spine Skins](https://eu.esotericsoftware.com/spine-skins), [Spine Basic Concepts](https://en.esotericsoftware.com/spine-basic-concepts), [PixiJS Scene Objects](https://pixijs.com/8.x/guides/components/scene-objects) und [PixiJS Render Layers](https://pixijs.com/8.x/guides/concepts/render-layers), ohne jetzt eine zusaetzliche Runtime einzufuehren.
